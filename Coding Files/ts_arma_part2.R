...
ma4=Arima(caemp_ts,order=c(0,0,4))
plot(forecast(ma4,h=36)) #one step ahead - all the other steps ahead will settle at the mean
...
plot(forecast(ar2,h=36),xlim=c(1990,2005)) # smoother - more desirable - goes to mean slower - do acf/pacf to confirm data of this set are more consistent with the test set
